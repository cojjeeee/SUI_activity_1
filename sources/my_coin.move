...
module my_coin::my_coin {
    ...
    fun create_currency<T: drop>(
        ...
        let url = url::new_unsafe_from_bytes(b"https://iamtzar.com/wp-content/uploads/2025/08/01.png");
            ...
            otw, 9, //// one-time-witness, it has 9 decimals
            b"MC", //// bitcoin initials
            b"My Coin", ////// pinaka bitcoin
            b"My First Ever Coin", /////// description
            option::some(url), ///// icon
            ctx ////transaction context
        );

        transfer::public_freeze_object(metadata);
        treasury_cap //// return treasury_cap
    }

    /// Mint `amount` of `Coin` and send it to `recipient`.
    public entry fun mint(
        c: &mut TreasuryCap<MY_COIN>, 
        amount: u64, /// ilang tokens gusto imint
        recipient: address,  ////kanino mapupunta ang tokens
